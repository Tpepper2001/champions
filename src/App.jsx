...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .nav-container { max-width: 1400px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; padding: 0.8rem 2rem; }
  
  .logo { display: flex; align-items: center; gap: 1rem; text-decoration: none; color: #0A1128; font-weight: 700; cursor: pointer; background: none; border: none; padding: 0; text-align: left; }
  .logo img { width: 90px; height: 90px; border-radius: 50%; object-fit: contain; background: white; border: 2px solid #F4D03F; }

  .nav-links { display: flex; gap: 2rem; list-style: none; }
  .nav-btn { background: none; border: none; color: #1A1A1A; font-weight: 600; font-size: 0.95rem; transition: color 0.3s; cursor: pointer; font-family: inherit; }
  .nav-btn:hover { color: #C86B56; }
  ...
  .hero-title { font-family: 'Playfair Display', serif; font-size: 6rem; font-weight: 900; color: white; line-height: 1; margin-bottom: 2rem; }
  ...
  .form-feedback-text { font-size: 0.85rem; color: #666; margin-top: 1rem; text-align: center; }
  ...
  .ceo-bio { font-size: 1.1rem; line-height: 1.8; color: #333; }
...
export default function App() {
    ...
    <>
      <section className="hero" id="home">
        ...
        <div className="hero-content">
          <div style={{ color: colors.gold, letterSpacing: '4px', fontWeight: 700, marginBottom: '1.5rem' }}>PURPOSE • STRATEGY • LEADERSHIP</div>
          <h1 className="hero-title">
            <span>Raising</span>
            <span className="highlight">Transformational</span>
            <span>Leaders</span>
          </h1>
          <p style={{ color: 'white', opacity: 0.95, fontSize: '1.4rem', maxWidth: '650px', marginBottom: '3rem' }}>
            Empowering the next generation to lead with clarity and character.
          </p>
      ...
      <section style={{ padding: '8rem 2rem', background: colors.cream }}>
        <div className="section-container" style={{ padding: 0 }}>
          <div className="section-header">
            ...
            <h2 className="section-title">Latest from Champions' Blog</h2>
          </div>
          <div style={{ maxWidth: '900px', margin: '0 auto', background: 'white', borderRadius: '30px', overflow: 'hidden', display: 'grid', gridTemplateColumns: '1fr 1fr', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' }}>
            <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=800" alt="Blog" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            <div style={{ padding: '3rem' }}>
              <div style={{ color: colors.terracotta, fontWeight: 700, fontSize: '0.8rem', marginBottom: '1rem' }}>FEATURED POST</div>
              <h3 style={{ fontFamily: 'Playfair Display', fontSize: '1.8rem', marginBottom: '1rem' }}>Leading with Purpose</h3>
              <p style={{ color: '#666', marginBottom: '1.5rem' }}>In a world of noise, purpose is the only compass that never fails. Learn how to define yours...</p>
              <button className="nav-btn" style={{ fontWeight: 800, padding: 0 }}>Read Full Article →</button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="section-container">
          ...
          <div className="form-card" style={{ maxWidth: '700px', margin: '0 auto' }}>
            <form action="https://formspree.io/f/mqeykgyy" method="POST">
              ...
              <p className="form-feedback-text">We'll get back to you via email for feedback.</p>
            </form>
          </div>
        </div>
      </section>
  ...
  const renderCEO = () => (
    <section style={{ background: 'white', paddingTop: '120px' }}>
      <div className="section-container">
        <div className="section-header">
          <div className="section-label">Our Leadership</div>
          <h2 className="section-title">Meet Jerry Oyedele</h2>
        </div>
        ...
        <div style={{ marginTop: '6rem' }}>
          <div className="section-header">
            ...
            <p style={{ marginTop: '1rem' }}>Invite Jerry Oyedele to your conference or event.</p>
          </div>
          <div className="form-card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            <form action="https://formspree.io/f/mqeykgyy" method="POST">
              <input type="hidden" name="type" value="CEO Conference Invitation" />
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                ...
                <div className="input-group">
                  <label className="input-label">Event Format</label>
              ...
              <div className="input-group">
                <label className="input-label">Physical Location (if applicable)</label>
              ...
              <div className="input-group">
                ...
                <input type="text" name="audience" className="form-input" required />
              </div>
              <div className="input-group">
                <label className="input-label">Your Email for Feedback</label>
                <input type="email" name="email" className="form-input" required />
              </div>
  ...
  const renderSession = () => (
    <section style={{ background: colors.cream, paddingTop: '120px', minHeight: '100vh' }}>
      <div className="section-container">
        <div className="section-header">
        ...
        <div className="form-card" style={{ maxWidth: '700px', margin: '0 auto' }}>
          <form action="https://formspree.io/f/mqeykgyy" method="POST">
            <input type="hidden" name="type" value="Session Booking" />
            <div className="input-group">
              <label className="input-label">Full Name</label>
              <input type="text" name="name" className="form-input" required />
            </div>
            ...
            <div className="input-group">
              <label className="input-label">Your Contact Information for Feedback</label>
              <input type="email" name="email" className="form-input" required placeholder="Enter email" />
            </div>
    ...
    <div>
      <nav className="navbar">
        <div className="nav-container">
          <button className="logo" onClick={() => { setView("home"); window.scrollTo(0,0); }}>
            <img src="https://ijsr.org.ng/wp-content/uploads/2026/03/CLG2.png" alt="CLG Logo" />
            <div>
              <div style={{ fontSize: '1.2rem' }}>Champions'</div>
              <div style={{ fontSize: '0.8rem', color: colors.terracotta }}>Leadership Global</div>
            </div>
          </button>
          <ul className="nav-links">
            <li><button className="nav-btn" onClick={() => setView("home")}>Home</button></li>
            <li><button className="nav-btn" onClick={() => setView("ceo")}>Meet Our CEO</button></li>
            <li><button className="nav-btn" onClick={() => setView("session")}>Book a Session</button></li>
            <li><button className="nav-btn" onClick={() => { setView("home"); setTimeout(() => scrollToSection("contact"), 100); }}>Contact</button></li>
          </ul>
        </div>
      </nav>
      ...
      <footer className="footer">
        <div className="section-container" style={{ padding: '0 2rem' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display', fontSize: '1.5rem' }}>Champions' Leadership Global</h3>
          <p style={{ opacity: 0.6, fontSize: '0.9rem', marginTop: '1rem' }}>© 2026 Champions' Leadership Global. Raising Transformational Leaders.</p>
        </div>
      </footer>
    </div>
  );
